...
TileLayoutPage_ByTileset:
    ...
    .include src/gfx_effects/redraw_entire_screen.asm
...
PRG030_9BD3:    .byte $00, $01
    ...
    .include src/gfx_effects/scroll_do_column.asm
    .include src/gfx_effects/scroll_do_attr_column.asm
